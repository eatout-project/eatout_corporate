...
export class CategoryApi {
  ...
  public postNewCategory(newCategory: CategoryRequestApiObject): Observable<RestaurantMenuCategoryApiObject[]>{
    return this.eatoutCorporateHttpClient.post<RestaurantMenuCategoryApiObject[]>('restaurant-service-cluster-ip-service:5000/addCategory', newCategory);
  }

  public getMenuCategories(restaurantId: number): Observable<RestaurantMenuCategoryApiObject[]> {
    return this.eatoutCorporateHttpClient.post<RestaurantMenuCategoryApiObject[]>('restaurant-service-cluster-ip-service:5000/getMenu', {id: restaurantId});
  }
